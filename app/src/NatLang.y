...
S:
      CNP CVP { $$ = MAKE_SYMBOL(ID_S, @$, 2, $1, $2); }
    ;
...
Infin_Bare:
    ...
    | V CNP CNP   { $$ = MAKE_SYMBOL(ID_INFIN_BARE, @$, 3, $1, $2, $3); }
    | V CNP       { $$ = MAKE_SYMBOL(ID_INFIN_BARE, @$, 2, $1, $2); }
    | V CNP PP_VP { $$ = MAKE_SYMBOL(ID_INFIN_BARE, @$, 3, $1, $2, $3); }
